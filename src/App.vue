...
const import_model=ref(JSON.stringify({
  "layout_center": {
    "x": 0,
    "y": 0
  },
...
<template>
  <div>
    <webtopo-svg-edit @on-return="onReturn" @on-preview="onPreview" @on-save="onSave"
      :custom-tool-bar="setCustomToolBar" :data-model="import_model"></webtopo-svg-edit>
  </div>
</template>
